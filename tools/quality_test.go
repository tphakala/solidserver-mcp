...
var expectedTools = map[string]toolClass{
	...
	"solidserver_dhcp_shared_network_list": classRead,
	"solidserver_dhcp_group_list":          classRead,
	"solidserver_dhcp_static_list":         classRead,
	...
	"solidserver_dhcp_shared_network_create": classAdditive,
	"solidserver_dhcp_group_create":          classAdditive,
	// destructive
	...
	"solidserver_dhcp_shared_network_delete": classDestructive,
	"solidserver_dhcp_group_delete":          classDestructive,
}
